...
function ReporteVacacion() {
    ...
    const moverIzquierda = () => {
        ...
        setEmpleadosDisponibles(prev => prev.filter(e => !checkedDer.includes(e.empleado_id || e.run)));
        setCheckedDer([]);
    }
    ...
    const handleGenerarReporte = async () => {
        ...
        try {
            for (const emp of empleadosSeleccionados) {
                ...
                a.href = url;
                a.download = `Reporte_Vacaciones_${emp.nombres}.pdf`;
    ...
    return (
        <>
            ...
            <Paper elevation={2} sx={{
                ...
                <Box sx={{ display: 'flex', flex: 1, gap: 2, minHeight: "250px", overflow: 'hidden' }}>
                                ...
                                {empleadosDisponibles.map((emp) => {
                                    ...
                                    return (
                                        <ListItem key={eid} dense button onClick={() => handleToggleIzq(eid)}>
                                            ...
                                            <ListItemText primary={`(${emp.run || emp.num_ficha || "-"}) ${emp.nombres} ${emp.apellido_paterno}`} />
                                        </ListItem>
                                    );
                                })}
                            </List>
...
export default ReporteVacacion;