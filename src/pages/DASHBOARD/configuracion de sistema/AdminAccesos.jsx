...
function AdminAccesos() {
    ...
    const [nuevaEmpresa, setNuevaEmpresa] = useState("") // Estado necesario para la limpieza al cerrar
                        ...
                        <Table stickyHeader sx={{ minWidth: 650, width: "100%" }} aria-label="tabla de usuarios">
                            <TableHead sx={{ '& th': { bgcolor: '#FFFFFD', borderBottom: '2px solid #ddd' } }}>
                                <TableRow>
                                    ...
                                    <TableCell width="25%" align="center"><strong>Url</strong></TableCell>
                                    <TableCell width="25%" align="center"><strong>Editar</strong></TableCell>
                                </TableRow>
                            </TableHead>
                        ...
                        <Paper variant="outlined" sx={{ p: 3, bgcolor: "#f9f9f9" }}>
                            ...
                            <Box sx={{ mb: 2 }}>
                                <TextField
                                    ...
                                    helperText={nuevoEtiqueta.trim() === "" ? "La etiqueta es obligatorio" : ""}
                                />
                            </Box>
                            ...
                            <Box sx={{ mb: 2 }}>
                                <TextField
                                    ...
                                    helperText={nuevoUrl.trim() === "" ? "La url es obligatorio" : ""}
                                />
                            </Box>
                        ...
                        <Paper variant="outlined" sx={{ p: 3, bgcolor: "#f9f9f9" }}>
                            ...
                            <Box sx={{ mb: 2 }}>
                                <TextField
                                    ...
                                    helperText={editEtiqueta.trim() === "" ? "La etiqueta es obligatorio" : ""}
                                />
                            </Box>
                            ...
                            <Box sx={{ mb: 2 }}>
                                <TextField
                                    ...
                                    helperText={editUrl.trim() === "" ? "La url es obligatorio" : ""}
                                />
                            </Box>
                        </Paper>
                    </Box>
