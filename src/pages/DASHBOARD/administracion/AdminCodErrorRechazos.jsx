                            ...
                            <Paper variant="outlined" sx={{ p: 3, bgcolor: "#f9f9f9" }}>
                                ...
                                <Box sx={{ mb: 2 }}>
                                    <TextField
                                        ...
                                        helperText={nuevoDescripcion.trim() === "" ? "La Descripcion es obligatoria" : ""}
                                    />
                                </Box>
                            ...
                            <Paper variant="outlined" sx={{ p: 3, bgcolor: "#f9f9f9" }}>
                                ...
                                <Box sx={{ mb: 2 }}>
                                    <TextField
                                        ...
                                        helperText={editDescripcion.trim() === "" ? "La Descripcion es obligatoria" : ""}
                                    />
                                </Box>
...
export default AdminCodErrorRechazos